...
Parse X(Twitter) video links via the redfox.hk API and return watermark-free direct download URLs.
...
def main():
    parser = argparse.ArgumentParser(
        description="X(Twitter) Video Downloader - parse videos via the redfox.hk API and return direct download links",
