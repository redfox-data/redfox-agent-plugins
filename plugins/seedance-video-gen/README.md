...
> Text-to-video generation with resolution, aspect ratio and duration control
...
AI video generator powered by Seedance 2.0 model. Input a keyword or description to generate an MP4 video. Supports text-to-video, resolution/aspect-ratio/duration control, and preset virtual human references for consistent character appearance.
...
2. Search for `seedance-video-gen` (or add the marketplace repo URL first)
3. Click **Install**
</details>
...
```bash
gemini extensions install https://github.com/redfox-data/redfox-agent-plugins --path plugins/seedance-video-gen
# or with Antigravity:
...
> Generate a 5-second video of a red fox running through a snowy forest
...
- Docs: <https://redfox.hk/skills/seedance-video-gen>
