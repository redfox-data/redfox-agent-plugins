...
> Watermark-free Instagram Reel and video downloader
...
Paste any Instagram video or Reel URL and get a watermark-free direct download link. Supports public posts, Reels, and IGTV. Perfect for saving content for offline viewing, remixing, or archiving before it gets deleted.
...
/plugin install instagram-video-downloader@redfox-agent-plugins
```
...
codex plugin add instagram-video-downloader@redfox-agent-plugins
```
...
2. Search for `instagram-video-downloader` (or add the marketplace repo URL first)
3. Click **Install**
</details>
...
```bash
gemini extensions install https://github.com/redfox-data/redfox-agent-plugins --path plugins/instagram-video-downloader
# or with Antigravity:
agy plugin install https://github.com/redfox-data/redfox-agent-plugins/plugins/instagram-video-downloader
```
...
```bash
cp -r plugins/instagram-video-downloader/skills/instagram-video-downloader ~/.agents/skills/
```
...
> Save this Instagram Reel: https://www.instagram.com/reel/xxxxx/
...
├── assets/logo.svg
└── skills/instagram-video-downloader/
...
- Docs: <https://redfox.hk/skills/instagram-video-downloader>
